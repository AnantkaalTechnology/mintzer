                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    nextPage(
                                        ...
                                        OrderDetailPage(
                                          dealDiscount:
                                              HomeApi.dealDiscount[index],
                                          productImage:
                                              HomeApi.dealImage[index],
                                          productTitle:
                                          ...
                                          productLink:
                                              HomeApi.dealOfferLink[index],
                                          productDealId:
                                              HomeApi.dealerId[index],
                                                            ...
                                                            OrderDetailPage(
                                                              ...
                                                              productOfferText:
                                                                  HomeApi.dealOfferText[
                                                                      index],
                                                              productYouSpend:
                                                                  HomeApi.dealYouSpend[
                                                                      index],
                                                              productTotalEarn:
                                                                  HomeApi.dealTotalEarnings[
                                                                      index],
                                                              productCashback:
                                                                  HomeApi.dealCashback[
                                                                      index],
                                                              productPrice:
                                                                  HomeApi.dealProductPrice[
                                                                      index],
                                                              productTotalReceive:
